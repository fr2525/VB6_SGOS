...
Begin VB.Form frmcadmoe 
   ...
   Begin MSFlexGridLib.MSFlexGrid MSFlexGrid1 
      ...
      ScrollBars      =   2
      SelectionMode   =   1
      FormatString    =   "Codigo  | Nome da Moeda                                                    | Símbolo "
   End
...
Private Sub cmdDelete_Click()
    ...
    If MsgBox("Deseja realmente apagar esta Moeda ? ", vbYesNo, "Atenção") = vbYes Then
